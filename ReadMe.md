...
Stock Momentum plus one opt-in toggle, **Open BLE Pairing**: a BLE central that can't bond — a
Garmin watch, say — gets to drive the Flipper over RPC, and the Flipper asks you on screen before
it allows it. Off by default, everything else untouched.

### Where things live

| | |
|---|---|
| The code | [`feature/open-ble-pairing`](../../tree/feature/open-ble-pairing) — every change is on that branch |
| How to install & build | [ReadMe on that branch](../../blob/feature/open-ble-pairing/ReadMe.md) |
| How it works, in detail | [`docs/OpenBlePairing.md`](../../blob/feature/open-ble-pairing/docs/OpenBlePairing.md) |
| The watch app | [Flipper Watch Remote](https://github.com/rz-x/flipper-on-garmin) |

> Not affiliated with the Momentum team. Everything below this line is Momentum's own ReadMe.
